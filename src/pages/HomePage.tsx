...
export default function HomePage() {
  ...
  return (
    <main className="site-shell">
      ...
      <div className="content-art-layer" aria-hidden="true">
        <img className="content-floating-prop content-prop-sickle" src={asset('assets/floating-sickle.png')} alt="" />
        <img className="content-floating-prop content-prop-camera" src={asset('assets/floating-camera.png')} alt="" />
        <img className="content-floating-prop content-prop-dagger" src={asset('assets/floating-dagger-wide.png')} alt="" />
        <img className="content-floating-prop content-prop-typewriter" src={asset('assets/floating-typewriter.png')} alt="" />
        <img className="content-floating-prop content-prop-revolver" src={asset('assets/floating-revolver.png')} alt="" />
      </div>
